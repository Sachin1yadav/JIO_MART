...
<div className="header">
      ...
      to="/" ><li><p>Home</p></li></NavLink> 
                    ...
                    <NavLink style={({ isActive }) =>
              isActive ? {color:"red"} : {color:"green"}
            }  to="/mens" ><li><p>Mens</p></li></NavLink> 
                   
                    <NavLink style={({ isActive }) =>
              isActive ? {color:"red"} : {color:"green"}
            }  to="/women" ><li><p>Women</p></li></NavLink> 
                     
                    <NavLink style={({ isActive }) =>
              isActive ? {color:"red"} : {color:"green"}
            }   to="/cart" ><li><p>Cart</p></li></NavLink> 
                    
                    <NavLink style={({ isActive }) =>
              isActive ? {color:"red"} : {color:"green"}
            } to="/sign" ><li><p>Register</p></li></NavLink> 
                   
                    <NavLink style={({ isActive }) =>
              isActive ? {color:"red"} : {color:"green"}
            }  to="/login" ><li><p>Login</p></li></NavLink>
